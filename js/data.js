const qnaList = [
  {
    q: '학교가 끝났습니다. 어디로 가시겠습니까?',
    a: [
      { answer: '집으로 간다.', type: ['cow', 'tiger', 'dragon', 'chick'] },
      { answer: 'PC방으로 간다.', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
    ]
  },
  {
    q: '집에 도착했습니다. 옷을 갈아 입으시겠습니까?',
    a: [
      { answer: '옷을 갈아입지 않는다.', type: ['mouse', 'rabbit', 'tiger', 'monkey'] },
      { answer: '옷을 갈아입는다.', type: ['cow', 'horse', 'snake', 'dog'] },
    ]
  },
  {
    q: '집에서 무엇을 하시겠습니까?',
    a: [
      { answer: '아무 것도 안함.', type: ['cow', 'rabbit', 'tiger', 'dog', 'monkey'] },
      { answer: '뭐라도 함.', type: ['sheep', 'chick', 'pig'] },
      { answer: '화장실을 간다.', type: ['mouse', 'horse', 'snake', 'dragon'] },
      { answer: '운동을 한다.', type: ['mouse']},
    ]
  },
]
